...
_Progress generated 2026-07-21 by `tools/gen_progress.py`. Run it after a session to refresh._
...
| Runtime dispatch entry points executed | 9,263 | |
| Deepest instrumented run | 167,772,160 dispatch blocks | |
